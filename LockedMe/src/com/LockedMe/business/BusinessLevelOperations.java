...
public class BusinessLevelOperations implements FileInterface {
	...
	public void searchFile() {
		...
		try {	
			Scanner scan= new Scanner(System.in);
			File directory = new File("D:\\\\LEARNING VIDEOS\\\\LockedMe");
